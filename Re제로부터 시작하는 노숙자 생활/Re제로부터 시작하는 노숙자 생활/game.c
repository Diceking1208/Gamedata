...
<<<<<<< HEAD
    sprintf_s(command, sizeof(command), "curl -d \"{\\\"ÇÃ·¹ÀÌ¾îID\\\":\\\"%d\\\",\\\"Á¢¼ÓÀÏ½Ã\\\":\\\"%d¿ù %dÀÏ\\\",\\\"¼ÒÁö±Ý\\\":%d,\\\"ÇöÀç´Ü°è\\\":%d,\\\"µµÀü´Ü°è\\\":%d,\\\"¼º°ø¿©ºÎ\\\":%s,\\\"±¸¸Å°¡±¸\\\":\\\"%d\\\",\\\"Áý°ª\\\":%d,\\\"ÁýÆÇ¸Å\\\":%s,\\\"½Ã°£\\\":\\\"%d:%d:%d\\\"}\" https://script.google.com/macros/s/AKfycbwQWUR_J5-boWCHJEFM48HQylhTUNfXdDgNFMs_mMaIIn3aodDP-nnAyJuQPXX5bNEI8g/exec",
...
>>>>>>> parent of 9eab5b8 (ê²Œìž„ë°ì´í„°ëª… ìˆ˜ì •, ì„ íƒì§€ ì¶”ê°€ ë“±)
=======
>>>>>>> bdf2804e626aa0e4cc944733db9f73a92859c1ef
    login();
    while (Isgame==1)
