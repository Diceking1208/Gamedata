        ...
        case 1:  Num = 95; buy = 4000;
            if (furnitureBuy) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    sell += (128000 * 2) + housePrice[level] * 2; // È²ï¿½İºï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ 128000 ï¿½ï¿½
                    break;
                case 4:
                    sell += (34000 * 2) + housePrice[level] * 2; // ï¿½Ë·Ï´Ş·Ï¿ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ 34000 ï¿½ï¿½
                    break;
                default:
                    break;}
    ...
    for (int i = 0; i < MAX_FURNITURE; ++i) {
        if (furnitureAvailable[i]) {
            ...
            case 1:
                ...
                break;
            case 2:
                printf("     3.È²ï¿½İºï¿½ï¿½ï¿½     (- 128,000 ï¿½ï¿½)\n");
                break;
            case 3:
                printf("     4.ï¿½Ë·Ï´Ş·Ï¿ï¿½ï¿½ï¿½  (- 34,000 ï¿½ï¿½)\n");
                break;
            }
        }
        else {
            ...
            case 1:
                ...
                break;
            case 2:
                printf("     3.È²ï¿½İºï¿½ï¿½ï¿½     (ï¿½Ç¸Å¿Ï·ï¿½)\n");
                break;
            case 3:
                printf("     4.ï¿½Ë·Ï´Ş·Ï¿ï¿½ï¿½ï¿½  (ï¿½Ç¸Å¿Ï·ï¿½)\n");
                break;
            }
        }
    }
...
>>>>>>> ce736913c6c021b816953a837d82823a848a13e5
    ...
    case 3:
        if (furnitureAvailable[2]) { //3ï¿½ï¿½Â° ï¿½ï¿½ï¿½ï¿½ ï¿½Ç¸ï¿½
            wallet -= 128000;
            printf("È²ï¿½İºï¿½ï¿½â¸¦ ï¿½ï¿½ï¿½ï¿½ï¿½Ï¿ï¿½ï¿½ï¿½ï¿½Ï´ï¿½.\n");
    ...
    case 4:
        if (furnitureAvailable[3]) {
            wallet -= 34000;
            printf("ï¿½Ë·Ï´Ş·Ï¿ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½Ï¿ï¿½ï¿½ï¿½ï¿½Ï´ï¿½.\n");
...
int login()
{
    ...
    printf("            ï¿½ï¿½ ï¿½ï¿½ ï¿½ï¿½\n", wallet);
    printf("---------------------------------------\n\n");
    printf("       idï¿½ï¿½ ï¿½Ğ¹ï¿½ï¿½ï¿½ ï¿½Ô·ï¿½ï¿½Ï¼ï¿½ï¿½ï¿½. \n");
    ...
    switch (userid)
    {
        ...
        case 1234:
            wallet = 999999999;
            printf(" ï¿½İ¾ï¿½ï¿½ï¿½ 999,999,999ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ÛµË´Ï´ï¿½. \n");
